...
const Ammunition9x39 = () => {



    const [allAmmunition9x39, setAllAmmunition9x39] = useState([])
    ...
    useEffect( () => {
        ...
        const options = {
            ...
            url: 'https://escape-from-tarkov.p.rapidapi.com/items/ammunitions/9x39',
        ...
        .then(response=>{
            ...
            setAllAmmunition9x39(response.data)
    ...
    return (
...

        {
                ...
                allAmmunition9x39.map( (ammunition, x) => {
