...
const Ammunition9x19 = () => {



    const [allAmmunition9x19, setAllAmmunition9x19] = useState([])
    ...
    useEffect( () => {
        ...
        const options = {
            ...
            url: 'https://escape-from-tarkov.p.rapidapi.com/items/ammunitions/9x19',
        ...
        .then(response=>{
            ...
            setAllAmmunition9x19(response.data)
    ...
    return (
...

        {
                ...
                allAmmunition9x19.map( (ammunition, x) => {
