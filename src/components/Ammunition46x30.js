...
const Ammunition46x30 = () => {



    const [allAmmunition46x30, setAllAmmunition46x30] = useState([])
    ...
    useEffect( () => {
        ...
        const options = {
            ...
            url: 'https://escape-from-tarkov.p.rapidapi.com/items/ammunitions/4.6x30',
        ...
        .then(response=>{
            ...
            setAllAmmunition46x30(response.data)
    ...
    return (
...

        {
                ...
                allAmmunition46x30.map( (ammunition, x) => {
...
export default Ammunition46x30;