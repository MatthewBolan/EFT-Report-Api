...
const Ammunition127x108 = () => {



    const [allAmmunition127x108, setAllAmmunition127x108] = useState([])
    ...
    useEffect( () => {
        ...
        const options = {
            ...
            url: 'https://escape-from-tarkov.p.rapidapi.com/items/ammunitions/12.7x108',
        ...
        .then(response=>{
            ...
            setAllAmmunition127x108(response.data)
    ...
    return (
...

        {
                ...
                allAmmunition127x108.map( (ammunition, x) => {
...
export default Ammunition127x108;
