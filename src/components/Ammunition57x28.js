...
const Ammunition57x28 = () => {



    const [allAmmunition57x28, setAllAmmunition57x28] = useState([])
    ...
    useEffect( () => {
        ...
        const options = {
            ...
            url: 'https://escape-from-tarkov.p.rapidapi.com/items/ammunitions/5.7x28',
        ...
        .then(response=>{
            ...
            setAllAmmunition57x28(response.data)
...
allAmmunition57x28.map( (ammunition, x) => {
...
export default Ammunition57x28;
