...
const Ammunition556x45 = () => {



    const [allAmmunition556x45, setAllAmmunition556x45] = useState([])
    ...
    useEffect( () => {
        ...
        const options = {
            ...
            url: 'https://escape-from-tarkov.p.rapidapi.com/items/ammunitions/5.56x45',
        ...
        .then(response=>{
            ...
            setAllAmmunition556x45(response.data)
    ...
    return (
...

        {
                ...
                allAmmunition556x45.map( (ammunition, x) => {
...
export default Ammunition556x45;
