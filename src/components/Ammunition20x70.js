...
const Ammunition20x70 = () => {



    const [allAmmunition20x70, setAllAmmunition20x70] = useState([])
    ...
    useEffect( () => {
        ...
        const options = {
            ...
            url: 'https://escape-from-tarkov.p.rapidapi.com/items/ammunitions/20x70',
        ...
        .then(response=>{
            ...
            setAllAmmunition20x70(response.data)
    ...
    return (
...

        {
                ...
                allAmmunition20x70.map( (ammunition, x) => {
...
export default Ammunition20x70;