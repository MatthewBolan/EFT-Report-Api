...
const Ammunition545x39 = () => {



    const [allAmmunition545x39, setAllAmmunition545x39] = useState([])
    ...
    useEffect( () => {
        ...
        const options = {
            ...
            url: 'https://escape-from-tarkov.p.rapidapi.com/items/ammunitions/5.45x39',
        ...
        .then(response=>{
            ...
            setAllAmmunition545x39(response.data)
    ...
    return (
...

        {
                ...
                allAmmunition545x39.map( (ammunition, x) => {
...
export default Ammunition545x39;