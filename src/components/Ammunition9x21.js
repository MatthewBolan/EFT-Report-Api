...
const Ammunition9x21 = () => {



    const [allAmmunition9x21, setAllAmmunition9x21] = useState([])
    ...
    useEffect( () => {
        ...
        const options = {
            ...
            url: 'https://escape-from-tarkov.p.rapidapi.com/items/ammunitions/9x21',
        ...
        .then(response=>{
            ...
            setAllAmmunition9x21(response.data)
    ...
    return (
...

        {
                ...
                allAmmunition9x21.map( (ammunition, x) => {
