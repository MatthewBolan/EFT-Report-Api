...
const Ammunition762x51 = () => {



    const [allAmmunition762x51, setAllAmmunition762x51] = useState([])
    ...
    useEffect( () => {
        ...
        const options = {
            ...
            url: 'https://escape-from-tarkov.p.rapidapi.com/items/ammunitions/7.62x51',
        ...
        .then(response=>{
            ...
            setAllAmmunition762x51(response.data)
    ...
    return (
...

        {
                ...
                allAmmunition762x51.map( (ammunition, x) => {
...
export default Ammunition762x51;