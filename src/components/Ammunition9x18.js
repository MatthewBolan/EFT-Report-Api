...
const Ammunition9x18 = () => {



    const [allAmmunition9x18, setAllAmmunition9x18] = useState([])
    ...
    useEffect( () => {
        ...
        const options = {
            ...
            url: 'https://escape-from-tarkov.p.rapidapi.com/items/ammunitions/9x18',
        ...
        .then(response=>{
            ...
            setAllAmmunition9x18(response.data)
    ...
    return (
...

        {
                ...
                allAmmunition9x18.map( (ammunition, x) => {
