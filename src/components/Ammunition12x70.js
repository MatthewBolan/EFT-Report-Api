...
const Ammunition12x70 = () => {



    const [allAmmunition12x70, setAllAmmunition12x70] = useState([])
    ...
    useEffect( () => {
        ...
        const options = {
            ...
            url: 'https://escape-from-tarkov.p.rapidapi.com/items/ammunitions/12x70',
        ...
        .then(response=>{
            ...
            setAllAmmunition12x70(response.data)
    ...
    return (
...

        {
                ...
                allAmmunition12x70.map( (ammunition, x) => {
...
export default Ammunition12x70;
