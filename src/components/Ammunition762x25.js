...
const Ammunition762x25 = () => {



    const [allAmmunition762x25, setAllAmmunition762x25] = useState([])
    ...
    useEffect( () => {
        ...
        const options = {
            ...
            url: 'https://escape-from-tarkov.p.rapidapi.com/items/ammunitions/7.62x25',
        ...
        .then(response=>{
            ...
            setAllAmmunition762x25(response.data)
    ...
    return (
...

        {
                ...
                allAmmunition762x25.map( (ammunition, x) => {
...
export default Ammunition762x25;